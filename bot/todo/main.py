...
@bot.message_handler(commands=['calculate_age'])
def send_welcome(message):
    bot.reply_to(message, "Hi! To calculate your age, please send me your birth date in the format 'YYYY-MM-DD'")
...
def age_calculator(message):
    try:
        ...
        bot.reply_to(message, f"Your age is {age} years old")
    except ValueError:
        bot.reply_to(message, "Invalid date format. Please try again with the format 'YYYY-MM-DD'")
...
def my_commands():
    return [
        ...
        BotCommand("/calculate_age", "calculate age"),
